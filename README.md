...
The version of PHP developed on was version 7.1.14 but it does not rely on any PHP7 features so in theory it should still run on older versions such as PHP 5.6 just fine.
